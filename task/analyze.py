...
# data
parser.add_argument('--data_name', default='Body3_L', type=str, help='choose dataset')
...
# net
parser.add_argument('--net_name', default='modlanet', type=str, help='Select model to train')
