...
class Dataset:
    ...
    def get_trajectory(self, t0=0, t_end=3, ode_stepsize=None, y0=None, noise_std=0., system="modlanet", **kwargs):
        ...
        if system == "hnn":
            dynamics_t, dynamics_solution = self.runge_kutta4_solver(self.hamilton_right_fn, t0, t_end, ode_stepsize,
                                                                     y0)
            ...
            dynamics_t, dynamics_solution = self.runge_kutta4_solver(self.lagrange_right_fn, t0, t_end, ode_stepsize,
                                                                     y0)
